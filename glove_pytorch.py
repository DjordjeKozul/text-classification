...
klase = ['Pozitivan review', 'Negativan review']
...
ax.set_xticks(np.arange(len(klase)))
ax.set_yticks(np.arange(len(klase)))
ax.set_xticklabels(klase)
ax.set_yticklabels(klase)
ax.set_xlabel('Predikcija', fontsize=12)
ax.set_ylabel('Prava labela', fontsize=12)
plt.title('Matrica konfuzije', fontsize=14)
plt.tight_layout()
plt.show()